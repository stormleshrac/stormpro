        ...
        if getUser['cloudtype'] == 'moodle':
            if getUser['uploadtype'] == 'evidence':
                try:
                    ...
                    pass
            if getUser['uploadtype'] == 'draft' or getUser['uploadtype'] == 'blog' or getUser[
                'uploadtype'] == 'calendar':
                for draft in client:
    ...
    try:
        ...
        #         bot.editMessageText(message,'❌Error y Causas🧐\n1-Revise su Cuenta\n2-Servidor Desabilitado: '+client.path)
            ...
            try:
                ...
                bot.editMessageText(message2,'La Moodle ' + user_info['moodle_host'] + ' No tiene Token o revise la Cuenta')
...
def main():
    ...
    # set in debug
    bot_token = '5360145583:AAG1I_5gaDTGOgy9R8Mlsg-tvsnTSG-TMtw'
